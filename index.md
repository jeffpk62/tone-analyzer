...
> **Service update:** *The {{site.data.keyword.toneanalyzershort}} service was updated on March 13, 2018. The customer-engagement endpoint now supports French input content. For more information about all recent updates, see the [Release notes](/docs/services/tone-analyzer/release-notes.html).*
