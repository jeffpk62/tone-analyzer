...
## Tone Analyzer サービスでのデータのラベル付けと削除
{: #gdpr-tone-analyzer}

{{site.data.keyword.toneanalyzerfull}} サービスはユーザーのデータを処理しますが、保管はしません。 {{site.data.keyword.toneanalyzershort}} サービスのユーザーは、このサービスの各自のデータを特定、保護、削除する操作を行う必要はありません。
